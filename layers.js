...
var lyr_sawah_4 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'sawah<br />\
    <img src="styles/legend/sawah_4_0.png" /> <br />'
        });
...
var lyr_kebun_5 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'kebun<br />\
    <img src="styles/legend/kebun_5_0.png" /> <br />'
        });
...
var lyr_lapangan_6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'lapangan<br />\
    <img src="styles/legend/lapangan_6_0.png" /> <br />'
        });
var format_irigasi_7 = new ol.format.GeoJSON();
var features_irigasi_7 = format_irigasi_7.readFeatures(json_irigasi_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_irigasi_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_irigasi_7.addFeatures(features_irigasi_7);
var lyr_irigasi_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_irigasi_7, 
                style: style_irigasi_7,
                popuplayertitle: "irigasi",
                interactive: true,
                title: '<img src="styles/legend/irigasi_7.png" /> irigasi'
            });
...
var lyr_jalan_8 = new ol.layer.Vector({
    ...
    <img src="styles/legend/jalan_8_3.png" /> 8<br />\
...
var lyr_Clipped_9 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Clipped<br />\
    <img src="styles/legend/Clipped_9_0.png" /> residential<br />\
    <img src="styles/legend/Clipped_9_1.png" /> service<br />\
    <img src="styles/legend/Clipped_9_2.png" /> trunk<br />\
    <img src="styles/legend/Clipped_9_3.png" /> unclassified<br />\
    <img src="styles/legend/Clipped_9_4.png" /> <br />'
        });
...
var format_Point_12 = new ol.format.GeoJSON();
var features_Point_12 = format_Point_12.readFeatures(json_Point_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Point_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Point_12.addFeatures(features_Point_12);
var lyr_Point_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Point_12, 
                style: style_Point_12,
                popuplayertitle: "Point",
                interactive: true,
    title: 'Point<br />\
    <img src="styles/legend/Point_12_0.png" /> bengkel<br />\
    <img src="styles/legend/Point_12_1.png" /> cf<br />\
    <img src="styles/legend/Point_12_2.png" /> instansi<br />\
    <img src="styles/legend/Point_12_3.png" /> instasi<br />\
    <img src="styles/legend/Point_12_4.png" /> kep<br />\
    <img src="styles/legend/Point_12_5.png" /> kes<br />\
    <img src="styles/legend/Point_12_6.png" /> mart<br />\
    <img src="styles/legend/Point_12_7.png" /> Mart<br />\
    <img src="styles/legend/Point_12_8.png" /> pend<br />\
    <img src="styles/legend/Point_12_9.png" /> pom<br />\
    <img src="styles/legend/Point_12_10.png" /> rm<br />\
    <img src="styles/legend/Point_12_11.png" /> tb<br />\
    <img src="styles/legend/Point_12_12.png" /> ti<br />\
    <img src="styles/legend/Point_12_13.png" /> UMKM<br />\
    <img src="styles/legend/Point_12_14.png" /> wir<br />\
    <img src="styles/legend/Point_12_15.png" /> <br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_gadm41_IDNADM_ADM_4_1.setVisible(true);lyr_RW_2.setVisible(true);lyr_RT_3.setVisible(true);lyr_sawah_4.setVisible(true);lyr_kebun_5.setVisible(true);lyr_lapangan_6.setVisible(true);lyr_irigasi_7.setVisible(true);lyr_jalan_8.setVisible(true);lyr_Clipped_9.setVisible(true);lyr_makam_10.setVisible(true);lyr_Clipped_11.setVisible(true);lyr_Point_12.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_gadm41_IDNADM_ADM_4_1,lyr_RW_2,lyr_RT_3,lyr_sawah_4,lyr_kebun_5,lyr_lapangan_6,lyr_irigasi_7,lyr_jalan_8,lyr_Clipped_9,lyr_makam_10,lyr_Clipped_11,lyr_Point_12];
...
lyr_irigasi_7.set('fieldAliases', {'id': 'id', });
lyr_jalan_8.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'lebar': 'lebar', });
...
lyr_Clipped_11.set('fieldAliases', {'osm_id': 'osm_id', 'osm_type': 'osm_type', 'addr_stree': 'addr_stree', 'access_roo': 'access_roo', 'building_m': 'building_m', 'building': 'building', 'isced_leve': 'isced_leve', 'roof_mater': 'roof_mater', 'capacity': 'capacity', 'amenity': 'amenity', 'name': 'name', 'emergency': 'emergency', 'addr_house': 'addr_house', });
lyr_Point_12.set('fieldAliases', {'id': 'id', 'Kel': 'Kel', 'Nama': 'Nama', });
...
lyr_irigasi_7.set('fieldImages', {'id': 'TextEdit', });
lyr_jalan_8.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'lebar': 'TextEdit', });
lyr_Clipped_9.set('fieldImages', {'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'depth': 'TextEdit', 'railway': 'TextEdit', 'blockage': 'TextEdit', 'amenity': 'TextEdit', 'name': 'TextEdit', 'width': 'TextEdit', 'public_tra': 'TextEdit', 'bridge': 'TextEdit', 'smoothness': 'TextEdit', 'landuse': 'TextEdit', 'covered': 'TextEdit', 'diameter': 'TextEdit', 'aeroway': 'TextEdit', 'waterway': 'TextEdit', 'parking': 'TextEdit', 'tunnel': 'TextEdit', 'building': 'TextEdit', 'operator': 'TextEdit', 'barrier': 'TextEdit', 'capacity': 'TextEdit', 'man_made': 'TextEdit', 'water': 'TextEdit', 'highway': 'TextEdit', 'surface': 'TextEdit', 'pump': 'TextEdit', 'oneway': 'TextEdit', 'layer': 'TextEdit', 'natural': 'TextEdit', });
lyr_makam_10.set('fieldImages', {'id': 'TextEdit', 'Nama': 'TextEdit', });
lyr_Clipped_11.set('fieldImages', {'osm_id': '', 'osm_type': '', 'addr_stree': '', 'access_roo': '', 'building_m': '', 'building': '', 'isced_leve': '', 'roof_mater': '', 'capacity': '', 'amenity': '', 'name': '', 'emergency': '', 'addr_house': '', });
lyr_Point_12.set('fieldImages', {'id': 'TextEdit', 'Kel': 'TextEdit', 'Nama': 'TextEdit', });
...
lyr_lapangan_6.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', });
lyr_irigasi_7.set('fieldLabels', {'id': 'no label', });
lyr_jalan_8.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', 'lebar': 'inline label - visible with data', });
lyr_Clipped_9.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'depth': 'no label', 'railway': 'no label', 'blockage': 'no label', 'amenity': 'no label', 'name': 'no label', 'width': 'no label', 'public_tra': 'no label', 'bridge': 'no label', 'smoothness': 'no label', 'landuse': 'no label', 'covered': 'no label', 'diameter': 'no label', 'aeroway': 'no label', 'waterway': 'no label', 'parking': 'no label', 'tunnel': 'no label', 'building': 'no label', 'operator': 'no label', 'barrier': 'no label', 'capacity': 'no label', 'man_made': 'no label', 'water': 'no label', 'highway': 'no label', 'surface': 'no label', 'pump': 'no label', 'oneway': 'no label', 'layer': 'no label', 'natural': 'no label', });
lyr_makam_10.set('fieldLabels', {'id': 'no label', 'Nama': 'inline label - visible with data', });
lyr_Clipped_11.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'addr_stree': 'no label', 'access_roo': 'no label', 'building_m': 'no label', 'building': 'no label', 'isced_leve': 'no label', 'roof_mater': 'no label', 'capacity': 'no label', 'amenity': 'no label', 'name': 'no label', 'emergency': 'no label', 'addr_house': 'no label', });
lyr_Point_12.set('fieldLabels', {'id': 'no label', 'Kel': 'no label', 'Nama': 'inline label - always visible', });
lyr_Point_12.on('precompose', function(evt) {
